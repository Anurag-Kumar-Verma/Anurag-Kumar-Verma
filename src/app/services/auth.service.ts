...
export class AuthService {
  ...
  public login(req: any): Observable<APIResponse<any>> {
    return this.http.post<APIResponse<any>>(`${environment.api}auth/login`, req, {headers: this.header}).pipe(map((value) => {
      console.log(value);
